为简单起见，做如下假设：假设样本空间\chi和假设空间H是离散的。令$P(h|X,\mathcal{L}_a)$代表算法\mathcal{L}_a基于训练数据X产生假设h的概率。令f代表我们希望学得的真实函数，对于二分类问题，假设真实目标函数可以是任何函数\chi\mapsto{0,1}，且所有可能的f符合均匀分布。
